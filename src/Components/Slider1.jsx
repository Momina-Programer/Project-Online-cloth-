  ...
  return (
    <>
     <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-[#6F6A42] ">Clients Feedback</h1>
          ...
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 pb-12">
            <li>
              <div className="h-full w-full">
                {/*                    <!-- Start Testimonial --> */}
                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200 w-96">
                  <div className="relative p-6">
                 
                      <blockquote className="p-6 text-lg leading-relaxed">
                       
                      </blockquote>
                     <b>  <h2>Maria Shabbir</h2> </b>
                        <p>
                        The customer experience was exceptional from 
